`
	<!-- invisible for invisible, visible for visible-->
    		<!-- generic receiver -->
        	<!-- 
            <li>
                    ...
                    <div class="user-chat-content">
                        <div class="ctext-wrap">
                            ...
                            <div class="dropdown align-self-start">
                                ...
                                <span class="dropdown-toggle visible" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    		...
    		<!-- generic receiver picture files -->
            <!-- <li>
                <div class="conversation-list">
                    <div class="chat-avatar">
                        <img src="/images/users/avatar-4.jpg" alt="">
                            ...
                            <div class="ctext-wrap-content">
                                <ul class="list-inline message-img  mb-0">
                                    ...
                                    <li class="list-inline-item message-img-list">
                                        <div>
                                            <a class="popup-img d-inline-block m-1" href="/images/small/img-2.jpg" title="Project 2">
    		...
    		<!-- generic sender document(zip) file -->
            <!-- <li class="right">
                <div class="conversation-list">
                    <div class="chat-avatar">
                        <img src="/images/users/avatar-1.jpg" alt="">
